...
- `Resolucion_Problemas_Busqueda_Adversarial_AlfaBeta_CristianCamiloOsorioGranada.ipynb` — Búsqueda adversarial: poda Alfa–Beta comparada con Minimax, con análisis del efecto del orden de exploración y aplicación a Tres en raya.
